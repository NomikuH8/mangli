...
class ImageConverter():
    ...
    def _generate_pdf(self, pdf_path):
        ...
        try:
            ...
            self._converted_images[0].save(pdf_path, save_all=True, append_images=other_imgs)
        except IndexError:
            try:
    ...
    def run_common(self, chap_paths: list, title_flag: str):
        ...
        print(fr'Internet browser link: "file://{pdf_file}"')
    ...
    def convert_all(self):
        ...
        for vol in range(len(volumes)):
            ...
            for i in os.listdir(vol_name):
                ...
                chapters.append(fr'{dir_path}/{vol_name}/{chap_name}')
                chap += 1
